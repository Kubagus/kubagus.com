...
const pathMap: Record<string, SimpleIcon> = {
  github: siGithub,
...
// Ikon merek yang tidak lagi tersedia di simple-icons, disimpan manual.
...
export function SocialIcon({ name, className }: SocialIconProps) {
  ...
  const manual = manualPaths[key];
  const icon = pathMap[key];
